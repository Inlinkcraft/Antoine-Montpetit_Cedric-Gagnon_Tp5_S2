...
public class FichierUtilitairesTest
{
	...
	public void Before() {
		...
		TEST_FILE = new File("JUnit/"+(int)(Math.random()*100000000)+".txt");
	}
	...
	{
		final String[] faux_dict = {"abcde","fghij","klmno","pqrts","uvwxy","z1234"};
		SortedSet<String> result = FichierUtilitaires.lireDictionnaire(NOM_FAUX_DICT);
		int i=0;
